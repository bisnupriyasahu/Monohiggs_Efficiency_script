...
mzp_map = {'2_0410_v2' : 'MZp_1000_MChi_1' ,  'DY': 'DYJetsToLL'}
canv=R.TCanvas("canvas","",0,0,1300,1200)
canv.cd()

vars = ['HiggsPt', 'tauPt', 'deltaR', 'muPt']
selections = ['4']
...
for idx in mzp_map:
	...
	if idx=='DY':
		file_name = 'output/DYJetsToLL_M-50_TuneCP5_0410_v2.root'
	...
	for var, selection, idtype in parameters:
		...
		canv.SaveAs('plots_0610_v1/eff_2017mutau_'+idtype+'_'+signal+'_'+var+'_'+selection+'.png')
