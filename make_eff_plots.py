...
mzp_map = {'2_0610_v3' : 'MZp_1000_MChi_1' ,  '7_0610_v3' : 'MZp_100_MChi_1'}
...
for idx in mzp_map:
	...
	if idx=='DY':
		file_name = 'output/DYJetsToLL_M-50_TuneCP5_0610_v3.root'
	infile = R.TFile(file_name, 'update')
        print"file name ",file_name
	for var, selection, idtype in parameters:
		signal = mzp_map[mzp_idx]
                #if var =='muPt':
                #raw_name = 'gentauPt_raw_0'
                #elif var =='tauPt':
                # raw_name = 'gensubleadingtauPt_raw_0'                  
		...
		idlist = idtypes[idtype]
                ...
                print"var ",var
                print" id ",idtype+idlist[0]
                print"seec ",selection
                hist_1 = infile.Get(var+'_'+idtype+idlist[0]+'_'+selection)
                print"hist 1 ",hist_1.GetName()
		...
		if var != 'deltaR':
			tmpHist_num1 = hist_1.Rebin(22, var+'_'+idtype+idlist[0]+'_'+selection )
			tmpHist_num2 = hist_2.Rebin(22, var+'_'+idtype+idlist[1]+'_'+selection )
			tmpHist_num3 = hist_3.Rebin(22, var+'_'+idtype+idlist[2]+'_'+selection )
			tmpHist_num4 = hist_4.Rebin(22, var+'_'+idtype+idlist[3]+'_'+selection )
			tmpHist_num5 = hist_5.Rebin(22, var+'_'+idtype+idlist[4]+'_'+selection )
		...
		print" before tmpHist_num1.Integral()",tmpHist_num1.Integral()
		tmpHist_num1.Divide(tmpHist_den)
		tmpHist_num2.Divide(tmpHist_den)
		tmpHist_num3.Divide(tmpHist_den)
		tmpHist_num4.Divide(tmpHist_den)
		tmpHist_num5.Divide(tmpHist_den)
                print"num {}/ denum {}".format(tmpHist_num1.GetName(),tmpHist_den.GetName())
		print"After tmpHist_num1.Integral()",tmpHist_num1.Integral()
                '''
		...
		canv.SaveAs('plots_case2/eff_2017mutau_'+idtype+'_'+signal+'_'+var+'_'+selection+'.png')
